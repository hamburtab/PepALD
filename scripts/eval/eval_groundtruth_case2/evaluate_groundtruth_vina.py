...
Typical usage:
    ...
    python scripts/eval/eval_groundtruth_case2/evaluate_groundtruth_vina.py \
        --config configs/training/dpo_2axi.json
    python scripts/eval/eval_groundtruth_case2/evaluate_groundtruth_vina.py \
        --sdf data/docking2/2axi_cyclicpep.sdf
...
DEFAULT_RECEPTOR = PROJECT_ROOT / "data" / "docking2" / "2axi_receptor.pdbqt"
DEFAULT_REF_SDF = PROJECT_ROOT / "data" / "docking2" / "2axi_cyclicpep.sdf"
...
def parse_args():
    ...
    parser.add_argument(
        ...
        help="Ligand SDF to score. Defaults to data/docking2/2axi_cyclicpep.sdf",
    )
    parser.add_argument(
        "--ref_sdf",
        type=str,
    ...
    parser.add_argument(
        ...
        help="Receptor PDBQT path. Defaults to data/docking2/2axi_receptor.pdbqt",
    )
    parser.add_argument(
        "--keep_workdir",
        action="store_true",
