#!/usr/bin/env python3
"""Score the case1 groundtruth ligand with PepTune solubility.

Default input:
    data/docking/raw_cyclic_pep.sdf

Default output:
    outputs/samples/case1/eval_groundtruth/case1_groundtruth.solubility.csv
"""
...
DEFAULT_SDF = PROJECT_ROOT / "data" / "docking" / "raw_cyclic_pep.sdf"
DEFAULT_OUTPUT = (
    PROJECT_ROOT
    / "outputs"
    / "samples"
    / "case1"
    / "eval_groundtruth"
    / "case1_groundtruth.solubility.csv"
)


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Score the case1 groundtruth ligand with PepTune solubility"
    )
    parser.add_argument(
        "--sdf",
        type=str,
