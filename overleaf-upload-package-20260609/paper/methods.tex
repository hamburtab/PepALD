...
\begin{figure*}[!t]%
\centering
\includegraphics[width=\textwidth]{result_data/fig1_7.png}
...
At each WP-DPO round, candidates are sampled from the preceding \mytool checkpoint, post-processed to enforce the target cyclic topology, deduplicated, filtered for valid Uni-Dock/Vina scoring, and ranked by the target-specific reward described above.
