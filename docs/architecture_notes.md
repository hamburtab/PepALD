...
scripts/train/train_pretrain.py # Training script
...
```python
from pepar_diff.models import CausalContextEncoder
...
```python
from pepar_diff.diffusion import DiffusionEngine
...
```python
from pepar_diff.models import TokenMapper

mapper = TokenMapper(
    vocab=vocab,
    embeddings_dir='./data/processed/unimol_embeddings',
...
```python
from pepar_diff.models import AutoregressiveRingPredictor
