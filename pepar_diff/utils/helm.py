...
monomer_library_path = current_dir.parent.parent / 'data' / 'processed' / 'monomer_library.csv'
...
def test():
    ...
    smi = cyclize_linpep_from_helm('{[Abu].[Sar].[meL].V.[meL].A.[dA].[meL].[meL].[meV].[Me_Bmt(E)]}', '1:R1-11:R2') 
    print(smi)
    print("\n")
