...
Typical usage:
    python eval/score_groundtruth_vina.py
    python eval/score_groundtruth_vina.py --config configs/dpo.json
    python eval/score_groundtruth_vina.py --sdf Vina/raw_cyclic_pep.sdf
...
from Vina.unidock_backend import (
    MAX_UNIDOCK_ATOMS,
    _build_unidock_cmd,
...
def parse_args():
    ...
    parser.add_argument(
        ...
        help="Ligand SDF to score. Defaults to Vina/raw_cyclic_pep.sdf",
    )
    parser.add_argument(
        "--ref_sdf",
        type=str,
    ...
    parser.add_argument(
        ...
        help="Receptor PDBQT path. Defaults to Vina/6dn5_receptor.pdbqt",
    )
    parser.add_argument(
        "--keep_workdir",
        action="store_true",
