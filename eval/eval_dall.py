...
Evaluate generated DPO samples with:
  ...
  2. Full structural metrics from utils.metrics_utils.Metrics

Default input:
    chembl32_samples/helm_dpo_samples.txt

Default Vina cache/output:
    chembl32_samples/dpo_generated_samples_score.csv
"""
...
from train_dpo import load_cached_vina_scores, resolve_path
...
DEFAULT_VINA_OUTPUT = "chembl32_samples/dpo_generated_samples_score.csv"
DEFAULT_PRIOR = "data/prior_data.csv"
