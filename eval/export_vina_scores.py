...
Usage:
    python eval/export_vina_scores.py
    python eval/export_vina_scores.py --config configs/dpo.json
    python eval/export_vina_scores.py --sample_file chembl32_samples/combined_candidates.txt
    python eval/export_vina_scores.py --vina_score_file chembl32_samples/combined_candidates.vina.csv
"""
...
from train_dpo import load_cached_vina_scores, load_candidate_helms, resolve_path
...
def main():
    ...
    vina_score_file = (
        ...
        or "chembl32_samples/combined_candidates.vina.csv"
    )
