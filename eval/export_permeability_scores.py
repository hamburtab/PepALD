...
Usage:
    python eval/export_permeability_scores.py
    python eval/export_permeability_scores.py \
        --input chembl32_samples/helm_chembl32only_r1r2_cyclized.txt \
        --output chembl32_samples/helm_chembl32only_r1r2_cyclized.perm.csv
"""
...
DEFAULT_INPUT = "chembl32_samples/helm_chembl32only_r1r2_cyclized.txt"
DEFAULT_OUTPUT = "chembl32_samples/helm_chembl32only_r1r2_cyclized.perm.csv"
